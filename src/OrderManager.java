...
public class OrderManager extends JFrame {
	...
	public static void main(String[] args) {
		// a ejemplificar ordermanager quien define la interfaz grafica de la
		// ventana
...
class ButtonHandler implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == objOrderManager.getOrderTypeCtrl()) {
			...
			// valida que haya seleccionado algo
			if (selection.equals("") == false) {
				// Se ejemplifica una fabrica de constructor
				BuilderFactory factory = new BuilderFactory();
				// se obtiene una ejemplificación de un constructor concreto
	...
	/**
	 * Metodo para crea una orden con solo el tipo de orden seleccionado
	 * 
	 * @param strOrderType
	 * @return
	 */
